...
\begin{figure}[ht]
    \begin{minipage}[c]{0.45\linewidth}
        ...
        \char91++++++++++\\
        \char91@@++++++++\\
        \char91!@+{\gnosw\char1\char3}+{\gnosw\char5}+++\\
        \char91!!+@{\gnosb\char2\char4}++++\\
        \char91++!@!!!!@+\\
        \char91++!@!@+@@+\\
        \char91++!!@@++++\\
        ,))))))))))\\
    ...
    \begin{minipage}[c]{0.55\linewidth}
        ...
        \char91@!@++++@@!++\\
        \char91@!@!@++@!!++\\
        \char91@@!!+{\gnosb\char3}{\gnosw\char2}!@+!+\\
        \char91@!+++{\gnosb\char5}{\gnosw\char4}{\gnosb\char1}+@!+\\
        ,))))))))))))\\
        }
        Ans.\ to Prob.\ 2
    \end{minipage}%
...
\begin{figure}[ht]
    \begin{minipage}[c]{0.5\linewidth}
        ...
        \char91+@++!+++\\
        \char91+@!!++++\\
        \char91+!@{\gnosw\char5}{\gnosb\char4}+++\\
        \char91+!\gnosEmptyLbl{\textit{a}}@{\gnosw\char1}{\gnosb\char6}@+\\
        \char91++{\gnosw\char7\char3}{\gnosb\char2}+++\\
        ,))))))))\\
        }
        Ans.\ to Prob.\ 1
    \end{minipage}%
    \begin{minipage}[c]{0.5\linewidth}
        ...
        \char91+!!@!+++\\
        \char91+++!++++\\
        \char91{\gnosw\char4}{\gnosb\char3}{\gnosw\char6}+++++\\
        \char91{\gnosb\char5}!{\gnosb\char7\char1}++++\\
        \char91++{\gnosw\char2}!@@++\\
        \char91+@@@!+++\\
        \char91+@!!!+!+\\
        \char91+@@!++++\\
...
\begin{figure}[ht]
    \begin{minipage}[c]{0.33\linewidth}
        ...
        +!@@++]\\
        ++!@++]\\
        +!\gnosEmptyLbl{\textit{a}}{\gnosw\char1}@@]\\
        +!@@!+]\\
        +@!!!+]\\
        ++++++]\\
        ++++++]\\
...
\begin{figure}[ht]
    ...
    \begin{minipage}[c]{0.41\linewidth}
        ...
        ++++++@@+]\\
        ++++@@!@+]\\
        \char42++{\gnosb\char3}{\gnosw\char2}!!!@]\\
        +++!{\gnosb\char1}+!@@]\\
        ++!+{\gnosw\char4}{\gnosb\char5}!@@]\\
        ++++@+@!!]\\
        ++++++@++]\\
        +++++++!+]\\
        \char42+++++*++]\\
